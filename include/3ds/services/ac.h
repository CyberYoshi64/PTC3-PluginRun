...
typedef enum {
	AC_TYPE_NONE = 0,           ///< Not connected to an AP.
	AC_TYPE_SLOT_1 = 1,         ///< Connected to user slot 1.
	AC_TYPE_SLOT_2 = 2,         ///< Connected to user slot 2.
	AC_TYPE_SLOT_3 = 4,         ///< Connected to user slot 3.
	AC_TYPE_UNK_3 = 8,          ///< Nintendo Wi-Fi USB Connector?
	AC_TYPE_NINTENDO_ZONE = 16, ///< Connected to a Nintendo Zone hotspot.
	AC_TYPE_FREESPOT = 128, 	///< Connected to "FREESPOT"
} acApType;

typedef enum {
	AC_STATE_NOCONNECT = 1, ///< Not connected.
	AC_STATE_INTERNET = 3,  ///< Connected to the internet.
	AC_STATE_100 = 100,     ///< Preparing Wi-Fi?
	AC_STATE_102 = 102,     ///< Unknown.
	AC_STATE_103 = 103,     ///< StreetPass?
	AC_STATE_200 = 200,     ///< Establishing internet connection?
} acState;
